...
//click on() with jQ eventlisteners for textbox
...
//eventlistener for save due date
...
$(this).children().each(function() {
  ...
  //trim down lists ID to match obj property
  var arrName = $(this)
    .attr("id")
    .replace("list-", "");
